...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 22, 2019 at 06:29 PM
...
CREATE TABLE `restorani` (
  ...
  `ContactInfo` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `About` varchar(1500) COLLATE utf8_unicode_ci NOT NULL,
