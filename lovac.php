...
<script async defer crossorigin="anonymous" src="https://connect.facebook.net/en_US/sdk.js#xfbml=1&version=v4.0&appId=2188085814821958&autoLogAppEvents=1"></script>
	...
	?>
		<div class="container">
			<div id="photosLovac" class="carousel slide d-none d-sm-block text-center" data-ride="carousel">
				<ul class="carousel-indicators">
					...
					<li data-target="#photosLovac" data-slide-to="9"></li>
					<li data-target="#photosLovac" data-slide-to="10"></li>
					<li data-target="#photosLovac" data-slide-to="11"></li>
					<li data-target="#photosLovac" data-slide-to="12"></li>
					<li data-target="#photosLovac" data-slide-to="13"></li>
					<li data-target="#photosLovac" data-slide-to="14"></li>
					<li data-target="#photosLovac" data-slide-to="15"></li>
					
				</ul>
				<div class="carousel-inner">
					
					<div class="carousel-item active">
						<img class="img-thumbnail" src=".\photos\Lovac\lovac1.jpg">
					</div>
					
					<div class="carousel-item">
						<img class="img-thumbnail" src=".\photos\Lovac\lovac2.jpg">
					</div>
					<div class="carousel-item">
						<img class="img-thumbnail" src=".\photos\Lovac\lovac3.jpg">
					</div>
					<div class="carousel-item">
						<img class="img-thumbnail" src=".\photos\Lovac\lovac4.jpg">
					</div>
					<div class="carousel-item">
						<img class="img-thumbnail" src=".\photos\Lovac\lovac5.jpg">
					</div>
					<div class="carousel-item">
						<img class="img-thumbnail" src=".\photos\Lovac\lovac6.jpg">
					</div>
					<div class="carousel-item">
						<img class="img-thumbnail" src=".\photos\Lovac\lovac7.jpg">
					</div>
					<div class="carousel-item">
						<img class="img-thumbnail" src=".\photos\Lovac\lovac8.jpg">
					</div>
					<div class="carousel-item">
						<img class="img-thumbnail" src=".\photos\Lovac\lovac9.jpg">
					</div>
					<div class="carousel-item">
						<img class="img-thumbnail" src=".\photos\Lovac\lovac9a.jpg">
					</div>
					<div class="carousel-item">
						<img class="img-thumbnail" src=".\photos\Lovac\lovac10.jpg">
					</div>
					<div class="carousel-item">
						<img class="img-thumbnail" src=".\photos\Lovac\lovac11.jpg">
					</div>
					<div class="carousel-item">
						<img class="img-thumbnail" src=".\photos\Lovac\lovac12.jpg">
                    </div>
                    <div class="carousel-item">
						<img class="img-thumbnail" src=".\photos\Lovac\lovac13.jpg">
                    </div>
                    <div class="carousel-item">
						<img class="img-thumbnail" src=".\photos\Lovac\lovac14.jpg">
                    </div>
                    <div class="carousel-item">
		...
		<div class="row d-sm-none">
			<div class="col-12"><img class="img img-fluid" src=".\photos\Lovac\lovac1.jpg">
            </div>
        </div>
		
		<div class="row d-sm-none">
            <div class="col-12"><img class="img img-fluid" src=".\photos\Lovac\lovac2.jpg">
		    </div>
        </div>
        
		<div class="row d-sm-none">
            <div class="col-12"><img class="img img-fluid" src=".\photos\Lovac\lovac3.jpg">
            </div>
        </div>
        
		<div class="row d-sm-none">
			<div class="col-12"><img class="img img-fluid" src=".\photos\Lovac\lovac4.jpg">
            </div>
        </div>
		
		<div class="row d-sm-none">
			<div class="col-12"><img class="img img-fluid" src=".\photos\Lovac\lovac5.jpg">
            </div>
        </div>
		
		<div class="row d-sm-none">
			<div class="col-12"><img class="img img-fluid" src=".\photos\Lovac\lovac6.jpg">
            </div>
        </div>
		
		<div class="row d-sm-none">
			<div class="col-12"><img class="img img-fluid" src=".\photos\Lovac\lovac7.jpg">
            </div>
        </div>
		<div class="row d-sm-none">
			<div class="col-12"><img class="img img-fluid" src=".\photos\Lovac\lovac8.jpg">
            </div>
        </div>
		
		<div class="row d-sm-none">
			<div class="col-12"><img class="img img-fluid" src=".\photos\Lovac\lovac9.jpg">
            </div>
        </div>
		
		<div class="row d-sm-none">
			<div class="col-12"><img class="img img-fluid" src=".\photos\Lovac\lovac9a.jpg">
            </div>
        </div>
		<div class="row d-sm-none">
			<div class="col-12"><img class="img img-fluid" src=".\photos\Lovac\lovac10.jpg">
        </div>
        </div>
        <div class="row d-sm-none">
			<div class="col-12"><img class="img img-fluid" src=".\photos\Lovac\lovac11.jpg">
        </div>
        </div>
        <div class="row d-sm-none">
			<div class="col-12"><img class="img img-fluid" src=".\photos\Lovac\lovac12.jpg">
        </div>
        </div>
        <div class="row d-sm-none">
			<div class="col-12"><img class="img img-fluid" src=".\photos\Lovac\lovac13.jpg">
        </div>
        </div>
        <div class="row d-sm-none">
			<div class="col-12"><img class="img img-fluid" src=".\photos\Lovac\lovac14.jpg">
        </div>
        </div>
        <div class="row d-sm-none">
			<div class="col-12"><img class="img img-fluid" src=".\photos\Lovac\lovac15.jpg">
        </div>
        </div>
